...
# Paths para execução do GenESyS Qt (aplicação compilada)
GENESYS_QT_SUBPATH=source/applications/gui/qt/GenesysQtGUI
GENESYS_QT_PRO_PATH=$GENESYS_QT_SUBPATH/GenesysQtGUI.pro
GENESYS_QT_RELEASE_SUBPATH=$GENESYS_QT_SUBPATH
GENESYS_QT_MAKEFILE_PATH=$GENESYS_QT_RELEASE_SUBPATH/Makefile
GENESYS_QT_EXECUTABLE_PATH=$GENESYS_QT_RELEASE_SUBPATH/GenesysQtGUI
